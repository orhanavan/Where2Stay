...
public class add_typeTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_type_two);
    ...
    public void addAdvert(View view) {
        ...
        storageReference.putFile(selected).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                databaseReference.child("Posts").child("satılık").child(uuidString).child("usermail").setValue(userEmail);
                databaseReference.child("Posts").child("satılık").child(uuidString).child("title").setValue(advTitle);
                databaseReference.child("Posts").child("satılık").child(uuidString).child("cost").setValue(advCost);
                databaseReference.child("Posts").child("satılık").child(uuidString).child("downloadurl").setValue(downloadURL);
